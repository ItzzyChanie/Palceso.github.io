...
<body>
    <div class="header">
        <nav id="navBar">
            ...
            <a href="register_form.php" class="Register-btn">Sign-Up / Sign-In</a>
    ...
    <div class="container">
        ...
        <button type="submit" class="start-btn" onclick="openPopup()">Book Now!</button>
        <div class="popup" id="popup">
            <h2>Oops!!</h2>
            <p>You don't have Account yet,<br>
            please Create Account First</p>
            <button type="button" onclick="closePopup()">OK</button>
            <button type="button" onclick="openPopup()"><a href="register_form.php">Register</a></button>
        </div>
        ...
        <span><a href="house.html">2</a></span>
        <span><a href="listing.html">3</a></span>
